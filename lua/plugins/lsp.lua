        ...
        config = function(_, opts)
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    if client and client.capabilities.textDocument.definition then
                        if client.name == "omnisharp" then
                            map("gd", require("omnisharp_extended").telescope_lsp_definitions, "Goto Definition")
                        else
                    ...
                    if client and client.capabilities.textDocument.implementation then
                        if client.name == "omnisharp" then
